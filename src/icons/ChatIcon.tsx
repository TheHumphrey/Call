...
export default function ChatIcon({ fill }: TProps) {
  return (
    <svg width="19" height="17" viewBox="0 0 19 17" fill={fill ? fill : 'none'} xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
